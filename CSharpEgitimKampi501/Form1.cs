...
namespace CSharpEgitimKampi501
{
    public partial class Form1 : Form
    {
        ...
        SqlConnection connection=new SqlConnection("Server=BESSOT;initial Catalog = EgitimKampi501Db;integrated security=true");
        ...
        private async void Form1_Load(object sender, EventArgs e)
        {
            ...
            lblDisctinctCategoryCount.Text = disctinctProductCount.ToString();
        }
    }
}
